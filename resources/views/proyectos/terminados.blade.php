...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('Proyectos Terminados') }}</div>

                <div class="card-body">
                    @if ($proyectosTerminados->isEmpty())
                        <div class="alert alert-info" role="alert">
                            No hay proyectos con estado "terminado" en este momento.
                        </div>
                    @else
                                ...
                                <tbody>
                                    @foreach ($proyectosTerminados as $proyecto)
                                        <tr>
                                            ...
                                            <td>{{ Str::limit($proyecto->descripcion, 50) }}</td> {{-- Limita la descripción --}}
                        ...
                        {{ $proyectosTerminados->links() }} {{-- Para la paginación --}}
                    @endif
                </div>
            </div>
            <div class="mt-3">
